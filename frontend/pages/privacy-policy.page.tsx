  ...
  return (
    <>
      ...
      <Box m={3} p={3}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Authier.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Authier, accessible from{' '}
              <a
                href="authier.ml"
        ...
        <ul>
          <li>
            <p>By email: authier.ml@google.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <a
                href="https://www.authier.ml/privacy"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.authier.ml/privacy
              </a>
            </p>
          </li>
        </ul>
