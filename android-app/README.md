...
Android Autofill supports native app login forms with exact package associations, explicit master-password unlock, and account selection. Add an Android package to a password item and enable Authier from Settings. WebViews and ambiguous forms are deliberately excluded from matching.
