...
export type SaveSecretsMutation = {
  __typename?: 'Mutation'
  me?:
    | {
        __typename?: 'UserMutation'
        saveEncryptedSecrets: { __typename?: 'EncryptedSecrets'; id: number }
      }
    | null
    | undefined
}
...
`
export type SaveSecretsMutationFn = Apollo.MutationFunction<
  SaveSecretsMutation,
 ...
 * });
 */
export function useSaveSecretsMutation(
  ...
  return Apollo.useMutation<SaveSecretsMutation, SaveSecretsMutationVariables>(
    SaveSecretsDocument,
    options
  )
}
export type SaveSecretsMutationHookResult = ReturnType<
  typeof useSaveSecretsMutation
>
export type SaveSecretsMutationResult =
  Apollo.MutationResult<SaveSecretsMutation>
export type SaveSecretsMutationOptions = Apollo.BaseMutationOptions<
  SaveSecretsMutation,
  SaveSecretsMutationVariables
>
