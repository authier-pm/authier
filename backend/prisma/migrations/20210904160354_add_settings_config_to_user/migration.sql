/*
  ...
  - Added the required column `noHandsLogin` to the `SettingsConfig` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "noHandsLogin" BOOLEAN NOT NULL,
