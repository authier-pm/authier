...
Object.defineProperty(exports, 'ReactApolloVisitor', {
  enumerable: true,
  get: function () {
    return visitor_js_1.ReactApolloVisitor
  }
})
const plugin = (schema, documents, config) => {
  ...
  const visitor = new visitor_js_1.ReactApolloVisitor(
    schema,
    allFragments,
    config,
    documents
...
const validate = async (schema, documents, config, outputFile) => {
  if (config.withComponent === true) {
    ...
    (0, path_1.extname)(outputFile) !== '.ts' &&
    (0, path_1.extname)(outputFile) !== '.tsx'
  ) {
    throw new Error(
