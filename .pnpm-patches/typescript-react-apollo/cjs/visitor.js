...
function hasRequiredVariables(node) {
  var _a, _b
  return (_b =
    (_a = node.variableDefinitions) === null || _a === void 0
      ? void 0
      : _a.some(
          (variableDef) =>
            variableDef.type.kind === graphql_1.Kind.NON_NULL_TYPE &&
...
class ReactApolloVisitor extends visitor_plugin_common_1.ClientSideBaseVisitor {
  constructor(schema, fragments, rawConfig, documents) {
    super(schema, fragments, rawConfig, {
      componentSuffix: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.componentSuffix,
        'Component'
      ),
      withHOC: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withHOC,
        false
      ),
      withComponent: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withComponent,
        false
      ),
      withHooks: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withHooks,
        true
      ),
      withMutationFn: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withMutationFn,
        true
      ),
      withRefetchFn: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withRefetchFn,
        false
      ),
      withFragmentHooks: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withFragmentHooks,
        false
      ),
      apolloReactCommonImportFrom: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.apolloReactCommonImportFrom,
        rawConfig.reactApolloVersion === 2
          ? '@apollo/react-common'
          : APOLLO_CLIENT_3_UNIFIED_PACKAGE
      ),
      apolloReactComponentsImportFrom: (0,
      visitor_plugin_common_1.getConfigValue)(
        rawConfig.apolloReactComponentsImportFrom,
        rawConfig.reactApolloVersion === 2
          ? '@apollo/react-components'
          : `${APOLLO_CLIENT_3_UNIFIED_PACKAGE}/react/components`
      ),
      apolloReactHocImportFrom: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.apolloReactHocImportFrom,
        rawConfig.reactApolloVersion === 2
          ? '@apollo/react-hoc'
          : `${APOLLO_CLIENT_3_UNIFIED_PACKAGE}/react/hoc`
      ),
      apolloReactHooksImportFrom: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.apolloReactHooksImportFrom,
        rawConfig.reactApolloVersion === 2
          ? '@apollo/react-hooks'
          : APOLLO_CLIENT_3_UNIFIED_PACKAGE
      ),
      reactApolloVersion: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.reactApolloVersion,
        3
      ),
      withResultType: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withResultType,
        true
      ),
      withMutationOptionsType: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.withMutationOptionsType,
        true
      ),
      addDocBlocks: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.addDocBlocks,
        true
      ),
      defaultBaseOptions: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.defaultBaseOptions,
        {}
      ),
      gqlImport: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.gqlImport,
        rawConfig.reactApolloVersion === 2
          ? null
          : `${APOLLO_CLIENT_3_UNIFIED_PACKAGE}#gql`
      ),
      hooksSuffix: (0, visitor_plugin_common_1.getConfigValue)(
        rawConfig.hooksSuffix,
        ''
      )
    })
  ...
  getDocumentNodeVariable(node, documentVariableName) {
    ...
    return this.config.documentMode ===
      visitor_plugin_common_1.DocumentMode.external
  ...
  _buildHocProps(operationName, operationType) {
    const typeVariableName =
      ...
      this.convertName(
        operationName +
          (0, change_case_all_1.pascalCase)(operationType) +
  ...
  _buildOperationHoc(
    ...
    const nodeName =
      (_b = (_a = node.name) === null || _a === void 0 ? void 0 : _a.value) !==
        null && _b !== void 0
        ? _b
        : ''
 ...
 */`
  ...
  _buildHooks(
    ...
    const hookFns = [
      `export function use${operationName}(baseOptions${shouldEnforceRequiredVariables ? '' : '?'}: ${this.getApolloReactHooksIdentifier()}.${operationType}HookOptions<${operationResultType}, ${operationVariablesTypes}>${
...
export function use${suspenseOperationName}(baseOptions?: ${this.getApolloReactHooksIdentifier()}.SkipToken | ${this.getApolloReactHooksIdentifier()}.SuspenseQueryHookOptions<${operationResultType}, ${operationVariablesTypes}>) {
  ...
  _buildRefetchFn(
    ...
    const operationDocComment =
      'description' in node
        ? (0, visitor_plugin_common_1.transformComment)(node.description)
        : ''
  ...
  get fragments() {
    ...
    for (const fragment of this['_fragments'].values()) {
      ...
      const IDType =
        (_b = this.scalars.ID) !== null && _b !== void 0 ? _b : 'string'
