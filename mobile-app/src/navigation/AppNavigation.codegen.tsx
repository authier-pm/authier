...
export function useSyncSettingsQuery(
  ...
  return Apollo.useQuery<SyncSettingsQuery, SyncSettingsQueryVariables>(
    SyncSettingsDocument,
    options
  )
}
export function useSyncSettingsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<SyncSettingsQuery, SyncSettingsQueryVariables>(
    SyncSettingsDocument,
    options
  )
}
export type SyncSettingsQueryHookResult = ReturnType<
  typeof useSyncSettingsQuery
>
export type SyncSettingsLazyQueryHookResult = ReturnType<
  typeof useSyncSettingsLazyQuery
>
export type SyncSettingsQueryResult = Apollo.QueryResult<
  SyncSettingsQuery,
  SyncSettingsQueryVariables
>
