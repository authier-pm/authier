...
export type UpdateEncryptedSecretMutation = {
  __typename?: 'Mutation'
  me: {
    ...
    encryptedSecret: {
      ...
      id: string
      update: { __typename?: 'EncryptedSecretGQL'; id: string }
    }
  }
}
...
`
export type UpdateEncryptedSecretMutationFn = Apollo.MutationFunction<
  UpdateEncryptedSecretMutation,
  UpdateEncryptedSecretMutationVariables
>
 ...
 * });
 */
export function useUpdateEncryptedSecretMutation(
  ...
  return Apollo.useMutation<
    UpdateEncryptedSecretMutation,
    UpdateEncryptedSecretMutationVariables
  >(UpdateEncryptedSecretDocument, options)
}
export type UpdateEncryptedSecretMutationHookResult = ReturnType<
  typeof useUpdateEncryptedSecretMutation
>
export type UpdateEncryptedSecretMutationResult =
  Apollo.MutationResult<UpdateEncryptedSecretMutation>
export type UpdateEncryptedSecretMutationOptions = Apollo.BaseMutationOptions<
  UpdateEncryptedSecretMutation,
  UpdateEncryptedSecretMutationVariables
>
